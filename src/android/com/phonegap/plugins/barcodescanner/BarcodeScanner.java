...
public class BarcodeScanner extends CordovaPlugin {
    ...
    private static final String DISABLE_SUCCESS_BEEP = "disableSuccessBeep";
            ...
            public void run() {
                ...
                if (args.length() > 0) {
                    ...
                    for (int i = 0; i < args.length(); i++) {
                        ...
                        intentScan.putExtra(Intents.Scan.BEEP_ON_SCAN, !obj.optBoolean(DISABLE_SUCCESS_BEEP, false));
